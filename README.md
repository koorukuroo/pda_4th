...
| 인스턴스-아키텍처 | Time taken for tests | Suc/Total Request | Request per second | Time per Request | Time per Request |
| ----------------- | -------------------- | ----------------- | ------------------ | ---------------- | ---------------- |
| M6g.large-Arm     | 0.006sec           | 20/20           |  3138.24[#/sec]     | 6.373ms  | 0.319ms |
| M6i.large-x86     | 0.005sec             | 20/20           | 4131.38[#/sec]      | 4.841ms          | 0.242ms |  

400명이 동시에 40명 접속할 때

| 인스턴스-아키텍처 | Time taken for tests | Suc/Total Request | Request per second | Time per Request | Time per Request |
| ----------------- | -------------------- | ----------------- | ------------------ | ---------------- | ---------------- |
| M6g.large-Arm     | 0.043sec           | 400/400           |  9257.76[#/sec]     | 4.321ms  | 0.108ms |
| M6i.large-x86     | 0.041sec             | 400/400           | 9693.21[#/sec]      | 4.127ms          | 0.103ms |
